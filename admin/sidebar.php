<aside class="sidebar">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link" href="manage_archive.php"><i class="bi bi-archive"></i><span>Archive</span></a></li>
    </ul>
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link" href="../auth/logout.php"><i class="bi bi-box-arrow-right"></i><span>Logout</span></a></li>
    </ul>
</aside>